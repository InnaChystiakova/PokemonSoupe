...
class PokemonListInfoTests: XCTestCase {
    ...
    func testHashable() {
        let pokemonListInfo1 = PokemonListInfo(count: 1118, next: "https://pokeapi.co/api/v2/pokemon?offset=20&limit=20", previous: nil, pokemonsInfo: [])
        let pokemonListInfo2 = PokemonListInfo(count: 1118, next: "https://pokeapi.co/api/v2/pokemon?offset=20&limit=20", previous: nil, pokemonsInfo: [])
